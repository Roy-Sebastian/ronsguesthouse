...
router.post('/', auth_middleware_1.requireAuth, (0, auth_middleware_1.requirePermission)('addon.manage'), addons_controller_1.create);
router.patch('/:id', auth_middleware_1.requireAuth, (0, auth_middleware_1.requirePermission)('addon.manage'), addons_controller_1.update);
router.delete('/:id', auth_middleware_1.requireAuth, (0, auth_middleware_1.requirePermission)('addon.manage'), addons_controller_1.remove);
