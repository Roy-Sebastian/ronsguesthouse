              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-2.5 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary/15 bg-gray-50 pr-8 ${form.guestId ? 'border-green-400 focus:border-green-400' : 'border-gray-200 focus:border-primary'}`}
                  />
                  {form.guestId && (
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500 text-xs font-bold">✓</span>
                  )}
                  {guestDropdownOpen && (filteredGuests.length > 0 || guestSearch) && (
